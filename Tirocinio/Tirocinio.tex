...
\subsubsection*{Fabbisogno proteico}
\begin{center}
\begin{tabular}{|c|c|c|c|}
\hline
& \makecell{\textbf{AR}\\\textbf{(g*kg di peso)}}&\makecell{\textbf{PRI}\\\textbf{(g*kg di peso)}}&\makecell{\textbf{SDT}\\\textbf{(g*kg di peso)}}\\\hline
...
\begin{center}
 ...
 \hline
 &&\makecell{\textbf{STD}\\\textbf{Obiettivo}\\\textbf{nutrizionale}} & \makecell{\textbf{AI}\\\textbf{Assunzione}\\\textbf{adeguata}} & \makecell{\textbf{PRI}\\\textbf{Intervallo di}\\\textbf{riferimento per}\\\textbf{l'assunzione di}\\\textbf{macronutrienti}}\\\hline
...
\begin{center}
 \begin{tabular}{|c|c|c|c|c|}
 \hline
 &\makecell{\textbf{AR}\\Fabbisogno\\medio}&\makecell{\textbf{PRI}\\Assunzione\\raccomandata\\per la \\popolazione}&\makecell{\textbf{AI}\\Assunzione\\adeguata}&\makecell{\textbf{UL}\\Livello massimo\\tollerabile\\di assunzione}\\\hline
